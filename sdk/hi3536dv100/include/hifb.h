...
typedef enum
{
    ...
    HIFB_FILTER_MODE = 0X80,              /*filter mode bitmask*/
    HIFB_LAYERMASK_BUTT
}HIFB_LAYER_INFO_MASKBIT;

typedef enum hiHIFB_LAYER_FILTER_MODE_E
{
    HIFB_LAYER_FILTER_MODE_COLOR = 0, /**< Filters the color */
    HIFB_LAYER_FILTER_MODE_ALPHA,     /**< Filters the alpha */
    HIFB_LAYER_FILTER_MODE_BOTH,      /* both color and alpha will be filter */
    HIFB_LAYER_FILTER_MODE_NONE,      /**<No filter *//**<CNcomment:$)A2;=xPPBK2( */
    HIFB_LAYER_FILTER_MODE_BUTT
} HIFB_LAYER_FILTER_MODE_E;
...
typedef struct
{
	...
	HIFB_LAYER_FILTER_MODE_E enFilterMode;
}HIFB_LAYER_INFO_S;
